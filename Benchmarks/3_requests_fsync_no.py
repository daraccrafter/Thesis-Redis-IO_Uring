...
output_dir_redis = os.path.join(base_csv_dir, "redis", "3", timestamp)
output_dir_redis_io_uring = os.path.join(base_csv_dir, "redis-io_uring", "3", timestamp)
graphs_dir = os.path.join(base_graphs_dir, "3", timestamp)
