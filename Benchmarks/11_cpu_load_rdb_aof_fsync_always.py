...
benchmark = "11_cpu_load_rdb_aof_fsync_always"
...
output_dir_redis = os.path.join(base_csv_dir, "redis", "11", timestamp)
output_dir_redis_io_uring = os.path.join(base_csv_dir, "redis-io_uring", "11", timestamp)
graphs_dir = os.path.join(base_graphs_dir, "11", timestamp)
