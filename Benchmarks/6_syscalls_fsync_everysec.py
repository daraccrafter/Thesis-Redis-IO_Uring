...
benchmark = "6_syscalls_fsync_everysec"
...
syscalls_dir_redis = os.path.join(base_csv_dir, "redis", "6", timestamp)
syscalls_dir_redis_io_uring = os.path.join(
    base_csv_dir, "redis-io_uring", "6", timestamp
)
graphs_dir = os.path.join(base_graphs_dir, "6", timestamp)
logs_redis_dir = os.path.join("logs", "redis", "6", timestamp)
logs_redis_io_uring_dir = os.path.join("logs", "redis-io_uring", "6", timestamp)
