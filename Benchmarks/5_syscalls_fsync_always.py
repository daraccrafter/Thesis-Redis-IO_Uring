...
syscalls_dir_redis = os.path.join(base_csv_dir, "redis", "5", timestamp)
syscalls_dir_redis_io_uring = os.path.join(
    base_csv_dir, "redis-io_uring", "5", timestamp
)
graphs_dir = os.path.join(base_graphs_dir, "5", timestamp)
logs_redis_dir = os.path.join("logs", "redis", "5", timestamp)
logs_redis_io_uring_dir = os.path.join("logs", "redis-io_uring", "5", timestamp)
