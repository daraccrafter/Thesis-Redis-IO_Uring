...
benchmark = "8_syscalls_comparison_aof_and_noaof"
...
syscalls_dir_redis = os.path.join(base_csv_dir, "redis", "8", timestamp)
syscalls_dir_redis_io_uring = os.path.join(
    base_csv_dir, "redis-io_uring", "8", timestamp
)
graphs_dir = os.path.join(base_graphs_dir, "8", timestamp)
logs_redis_dir = os.path.join("logs", "redis", "8", timestamp)
logs_redis_io_uring_dir = os.path.join("logs", "redis-io_uring", "8", timestamp)
